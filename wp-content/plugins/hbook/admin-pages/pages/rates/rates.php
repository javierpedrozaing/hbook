	...
	<div class="wrap">
		...
		<script id="discount_edit_tmpl" type="text/html">
			<tr>
				...
				<td>
					...
					<label for="hb-discount-apply-to-type-accom"><?php echo( esc_html( 'Accommodation price', 'hbook-admin' ) ); ?></label>
					<br/>
					<input data-bind="checked: apply_to_type" id="hb-discount-apply-to-type-global" type="radio" value="global" />
					<label for="hb-discount-apply-to-type-global"><?php echo( esc_html( 'Global price', 'hbook-admin' ) ); ?></label>
				</td>
		...
		<script id="coupon_edit_tmpl" type="text/html">
			<tr>
				...
				<td><input data-bind="value: date_limit" type="text" class="hb-coupon-limit-date" /></td>
				<!--
				<td>
...
<?php
	...
	private function display_rules_checkbox_list() {
		foreach ( $this->rules as $id => $rule ) {
			...
			?>
			<input id="<?php echo( esc_attr( $tag_id ) ); ?>" data-bind="checked: rules, disable: all_rules" type="checkbox" value="<?php echo( $id ); ?>" />
